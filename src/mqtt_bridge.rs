...
mod tests {
    ...
    #[test]
    fn test_wildcard_matching_multi_level() {
        // Test multi-level wildcard (#)
        assert!(MqttBridge::matches_wildcard("iot/#", "iot/sensors/temperature"));
        assert!(MqttBridge::matches_wildcard("iot/#", "iot/sensors/temperature/room1"));
        assert!(MqttBridge::matches_wildcard("iot/#", "iot/actuators"));
        assert!(MqttBridge::matches_wildcard("iot/sensors/#", "iot/sensors/temperature"));
        assert!(MqttBridge::matches_wildcard("iot/sensors/#", "iot/sensors/temperature/room1"));
        
        // Should not match
        assert!(!MqttBridge::matches_wildcard("iot/#", "home/sensors/temperature"));
        assert!(!MqttBridge::matches_wildcard("iot/sensors/#", "iot/actuators/valve"));
    }
    
    #[test]
    fn test_wildcard_matching_single_level() {
        // Test single-level wildcard (+)
        assert!(MqttBridge::matches_wildcard("iot/+/temperature", "iot/sensors/temperature"));
        assert!(MqttBridge::matches_wildcard("iot/+/temperature", "iot/devices/temperature"));
        assert!(MqttBridge::matches_wildcard("+/sensors/+", "iot/sensors/temperature"));
        assert!(MqttBridge::matches_wildcard("+/sensors/+", "home/sensors/humidity"));
        
        // Should not match (+ only matches one level)
        assert!(!MqttBridge::matches_wildcard("iot/+/temperature", "iot/sensors/room1/temperature"));
        assert!(!MqttBridge::matches_wildcard("iot/+", "iot/sensors/temperature"));
    }
    
    #[test]
    fn test_wildcard_matching_mixed() {
        // Test mixed wildcards
        assert!(MqttBridge::matches_wildcard("iot/+/sensors/#", "iot/building1/sensors/temperature"));
        assert!(MqttBridge::matches_wildcard("iot/+/sensors/#", "iot/building1/sensors/temperature/room1"));
        assert!(MqttBridge::matches_wildcard("+/+/#", "iot/sensors/temperature/room1"));
        
        // Should not match
        assert!(!MqttBridge::matches_wildcard("iot/+/sensors/#", "home/building1/sensors/temperature"));
    }
    
    #[test]
    fn test_wildcard_matching_exact() {
        // Test exact matches (no wildcards)
        assert!(MqttBridge::matches_wildcard("iot/sensors/temperature", "iot/sensors/temperature"));
        assert!(!MqttBridge::matches_wildcard("iot/sensors/temperature", "iot/sensors/humidity"));
    }
}
